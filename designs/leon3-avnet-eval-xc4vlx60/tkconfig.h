...
#ifdef CONFIG_MMU_VARIABLE_PAGESIZE
#if defined CONFIG_MMU_VARIABLE_PAGESIZE_I0
#define CONFIG_MMU_VARIABLE_PAGESIZE_DEF 0
#elif defined CONFIG_MMU_VARIABLE_PAGESIZE_I1
#define CONFIG_MMU_VARIABLE_PAGESIZE_DEF 1
#elif defined CONFIG_MMU_VARIABLE_PAGESIZE_I2
#define CONFIG_MMU_VARIABLE_PAGESIZE_DEF 2
#elif defined CONFIG_MMU_VARIABLE_PAGESIZE_I3
#define CONFIG_MMU_VARIABLE_PAGESIZE_DEF 3
#elif defined CONFIG_MMU_VARIABLE_PAGESIZE_I4
#define CONFIG_MMU_VARIABLE_PAGESIZE_DEF 4
#elif defined CONFIG_MMU_VARIABLE_PAGESIZE_I5
#define CONFIG_MMU_VARIABLE_PAGESIZE_DEF 5
#endif
#else
#define CONFIG_MMU_VARIABLE_PAGESIZE_DEF 0
#endif
